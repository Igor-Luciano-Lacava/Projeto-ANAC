--vai separar aquilo que passou e nao passou e deixou em quarentena
--Objetivo da quarentena: que alguem que conheça sobre o negócio e sobre os dados verifique o porquê de os dados estarem com problemas. Avaliar o dado e dar condiçoes de verificar e tratar o problema que os dados geraram
-- ---------------------------------------------------------------------------
